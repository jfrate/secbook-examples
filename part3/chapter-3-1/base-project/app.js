...
app.get('/', (req, res) => {
  ...
  res.send(page('Home', `
    <h1>Hello, World</h1>
    <p>This app demonstrates simple username/password login and role-based access control.</p>
    <p>Try logging in with:</p>
    <ul>
      <li><code>alice / password123</code> (role: admin)</li>
      <li><code>bob / password123</code> (role: user)</li>
    </ul>
    <p>Protected pages:</p>
    <ul>
